...
- [ ] Replace async poll loading pattern (drone/obstacle glTF) with `AssetEvent` observers or `AssetServer::is_loaded_with_dependencies()` — removes per-frame early-return guards.
