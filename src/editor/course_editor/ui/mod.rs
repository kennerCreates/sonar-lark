...
pub use systems::{
    ...
    handle_palette_selection, handle_prop_color_cycle, handle_prop_palette_selection,
    handle_tab_switch, handle_transform_mode_buttons, setup_prop_editor_meshes,
    update_display_values, update_gate_count_display, update_prop_color_label,
