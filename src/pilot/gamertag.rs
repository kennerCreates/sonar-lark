...
const ROOTS: &[&str] = &[
    ...
    "Cleo", "Jade", "Mira", "Stella", "Kira", "Elektra", "Selene", "Sable", "Phaedra",
    "Vesper", "Artemis", "Iris", "Wren", "Crimson", "Banshee", "Soraya", "Lux", "Rogue",
    "Pandora", "Medusa", "Calypso", "Persephone", "Juno", "Hera", "Demeter", "Circe",
    "Minerva", "Diana", "Brigid", "Amara", "Theia", "Rhea", "Gaia", "Eris", "Nemesis",
    "Pixie", "Zephyr", "Diva", "Bliss", "Shimmer", "Velvet", "Mirage", "Starling", "Whisper",
    "Opal", "Pearl", "Sapphire", "Garnet", "Amethyst", "Topaz", "Ruby", "Scarlet", "Ivory", "Silver",
    "Venom", "Spite", "Dagger", "Thorn", "Scythe", "Shade", "Prowl", "Sting",
    "Riot", "Rebel", "Blaze", "Striker", "Mystic", "Spectra", "Glimmer",
    ...
    "Aileron", "Yaw", "Rudder", "Pitch", "Rotor", "Prop", "Airfoil", "Slipstream", "Tailwind", "Updraft",
    "Crosswind", "Headwind", "Jetstream", "Thermal", "Glide", "Liftoff", "Altitude", "Mach", "Aero", "Contrail",
    "Redline", "Burnout", "Clutch", "Downforce", "Drafting", "Gridlock", "Holeshot", "Kickstart", "Overdrive",
    "Slingshot", "Whiplash", "Breakaway", "Flyby", "Lowpass", "Hairpin", "Chicane", "Splittime", "Podium",
    "Kwad", "FreeStyle", "Acro", "Rollout", "Inverted", "Matty", "Juicy", "Bando", "Rip", "Floaty",
    "Jostle", "Powerloop", "Splitess", "Snaproll", "Corkscrew", "Divebomb", "Proximity", "Gap", "Whoop",
    "Lithium", "Capacitor", "Gyro", "Firmware", "Betaflight", "Amplifier", "Diode", "Transistor", "Ohm", "Watt",
    "Voltage", "Resistor", "Solder", "Antenna", "Relay", "Oscillator", "Photon", "Electron", "Cathode",
    "Bandit", "Bogey", "Maverick", "Afterburner", "Scramble", "Wingman", "Tango", "Foxhound", "Talon",
    "Raptor", "Hornet", "Blackbird", "Nighthawk", "Warthog", "Tomcat", "Reaper", "Predator",
];
